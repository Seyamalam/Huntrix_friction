...
| --- | --- |
|  |  |
| [Paradigm](https://en.wikipedia.org/wiki/Programming_paradigm) | [Multi-paradigm](https://en.wikipedia.org/wiki/Multi-paradigm_programming_language): [concurrent](https://en.wikipedia.org/wiki/Concurrent_programming), [imperative](https://en.wikipedia.org/wiki/Imperative_programming), [functional](https://en.wikipedia.org/wiki/Functional_programming), [object-oriented](https://en.wikipedia.org/wiki/Object-oriented_programming) |
| [Designed by](https://en.wikipedia.org/wiki/Software_design) | [Robert Griesemer](https://en.wikipedia.org/wiki/Robert_Griesemer)   [Rob Pike](https://en.wikipedia.org/wiki/Rob_Pike)   [Ken Thompson](https://en.wikipedia.org/wiki/Ken_Thompson) |
| [Developer](https://en.wikipedia.org/wiki/Software_developer) | The Go Authors |
| First appeared | November 10, 2009 (2009-11-10) |
|  |  |
| [Stable release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | 1.26.2     / 7 April 2026 (7 April 2026) |
|  |  |
| [Typing discipline](https://en.wikipedia.org/wiki/Type_system) | [Inferred](https://en.wikipedia.org/wiki/Type_inference), [static](https://en.wikipedia.org/wiki/Static_typing), [strong](https://en.wikipedia.org/wiki/Strong_typing), [structural](https://en.wikipedia.org/wiki/Structural_typing), [nominal](https://en.wikipedia.org/wiki/Nominal_typing) |
| [Memory management](https://en.wikipedia.org/wiki/Memory_management) | [Garbage collection](https://en.wikipedia.org/wiki/Garbage_collection_(computer_science)) |
| Implementation language | Go, [Assembly language](https://en.wikipedia.org/wiki/Assembly_language) (gc); [C++](https://en.wikipedia.org/wiki/C%2B%2B) (gofrontend) |
| [OS](https://en.wikipedia.org/wiki/Operating_system) | [DragonFly BSD](https://en.wikipedia.org/wiki/DragonFly_BSD), [FreeBSD](https://en.wikipedia.org/wiki/FreeBSD), [Linux](https://en.wikipedia.org/wiki/Linux), [macOS](https://en.wikipedia.org/wiki/MacOS), [NetBSD](https://en.wikipedia.org/wiki/NetBSD), [OpenBSD](https://en.wikipedia.org/wiki/OpenBSD), [Plan 9](https://en.wikipedia.org/wiki/Plan_9_from_Bell_Labs), [Solaris](https://en.wikipedia.org/wiki/Solaris_(operating_system)), [Windows](https://en.wikipedia.org/wiki/Windows) |
| [License](https://en.wikipedia.org/wiki/Software_license) | [3-clause BSD](https://en.wikipedia.org/wiki/3-clause_BSD) + [patent](https://en.wikipedia.org/wiki/Software_patents) grant |
| [Filename extensions](https://en.wikipedia.org/wiki/Filename_extension) | .go |
| Website | [go.dev](https://go.dev) |
| Major [implementations](https://en.wikipedia.org/wiki/Programming_language_implementation) |  |
| gc, gofrontend, [gold](https://en.wikipedia.org/wiki/Elements_Toolchain) |  |
| Influenced by |  |
| [C](https://en.wikipedia.org/wiki/C_(programming_language)), [Oberon-2](https://en.wikipedia.org/wiki/Oberon-2), [Limbo](https://en.wikipedia.org/wiki/Limbo_(programming_language)), [Active Oberon](https://en.wikipedia.org/wiki/Active_Oberon), [communicating sequential processes](https://en.wikipedia.org/wiki/Communicating_sequential_processes), [Pascal](https://en.wikipedia.org/wiki/Pascal_(programming_language)), [Oberon](https://en.wikipedia.org/wiki/Oberon_(programming_language)), [Smalltalk](https://en.wikipedia.org/wiki/Smalltalk), [Newsqueak](https://en.wikipedia.org/wiki/Newsqueak), [Modula-2](https://en.wikipedia.org/wiki/Modula-2), [Alef](https://en.wikipedia.org/wiki/Alef_(programming_language)), [APL](https://en.wikipedia.org/wiki/APL_(programming_language)), [BCPL](https://en.wikipedia.org/wiki/BCPL), [Modula](https://en.wikipedia.org/wiki/Modula), [occam](https://en.wikipedia.org/wiki/Occam_(programming_language)) |  |
| Influenced |  |
| [Crystal](https://en.wikipedia.org/wiki/Crystal_(programming_language)), [V](https://en.wikipedia.org/wiki/V_(programming_language)) |  |
...
* [Readability](https://en.wikipedia.org/wiki/Readability) and [usability](https://en.wikipedia.org/wiki/Usability) (like [Python](https://en.wikipedia.org/wiki/Python_(programming_language)))
...
A drawing of Go's mascot, a cartoon 

[gopher](https://en.wikipedia.org/wiki/Gopher)
...
Go is influenced by [C](https://en.wikipedia.org/wiki/C_(programming_language)) (especially the [Plan 9](https://en.wikipedia.org/wiki/Plan_9_from_Bell_Labs) [dialect](https://en.wikipedia.org/wiki/Dialect_(computing))), but with an emphasis on greater simplicity and safety. It consists of:
...
* Distinctive approaches to particular problems:
    ...
    * Built-in concurrency primitives: [light-weight processes](https://en.wikipedia.org/wiki/Light-weight_process) (goroutines), [channels](https://en.wikipedia.org/wiki/Channel_(programming)), and the `select` statement
    * An [interface](https://en.wikipedia.org/wiki/Protocol_(object-oriented_programming)) system in place of [virtual inheritance](https://en.wikipedia.org/wiki/Virtual_inheritance), and type embedding instead of non-virtual inheritance
    * A toolchain that, by default, produces [statically linked](https://en.wikipedia.org/wiki/Static_library) native binaries without external Go dependencies
...
Aside from its support for interfaces, Go's type system is [nominal](https://en.wikipedia.org/wiki/Nominal_type_system): the `type` keyword can be used to define a new *named type*, which is distinct from other named types that have the same layout (in the case of a `struct`, the same members in the same order). Some conversions between types (e.g., between the various integer types) are pre-defined and adding a new type may define additional conversions, but conversions between named types must always be invoked explicitly. For example, the `type` keyword can be used to define a type for [IPv4](https://en.wikipedia.org/wiki/IPv4) addresses, based on 32-bit unsigned integers as follows:
...
Go provides two features that replace [class inheritance](https://en.wikipedia.org/wiki/Inheritance_(object-oriented_programming)).
...
* [Fat pointer](https://en.wikipedia.org/wiki/Fat_pointer)
* [Fyne (software)](https://en.wikipedia.org/wiki/Fyne_(software)) — [widget toolkit](https://en.wikipedia.org/wiki/Widget_toolkit) for creating [GUIs](https://en.wikipedia.org/wiki/Graphical_user_interface) with Go
* [Comparison of programming languages](https://en.wikipedia.org/wiki/Comparison_of_programming_languages)
* [List of Go software and tools](https://en.wikipedia.org/wiki/List_of_Go_software_and_tools)

## Notes

1. **^** But "To allow complex statements to occupy a single line, a semicolon may be omitted before a closing ) or }".
2. **^** "if the newline comes after a token that could end a statement, [the lexer will] insert a semicolon".
3. **^** Usually, exactly one of the result and error values has a value other than the type's zero value; sometimes both do, as when a read or write can only be partially completed, and sometimes neither, as when a read returns 0 bytes. See [Semipredicate problem: Multivalued return](https://en.wikipedia.org/wiki/Semipredicate_problem#Multivalued_return).
4. ^   Language FAQ "Why is there no pointer arithmetic? Safety ... never derive an illegal address that succeeds incorrectly ... using array indices can be as efficient as ... pointer arithmetic ... simplify the implementation of the garbage collector...."
5. **^** Language FAQ "Why does Go not have assertions? ...our experience has been that programmers use them as a crutch to avoid thinking about proper error handling and reporting...."
6. **^** Language FAQ "Why are there no untagged unions...? [they] would violate Go's memory safety guarantees."
7. **^** Language FAQ "Why does Go not have variant types? ... We considered [them but] they overlap in confusing ways with interfaces.... [S]ome of what variant types address is already covered, ... although not as elegantly." (The tag of an interface type is accessed with a type assertion).
8. **^** Questions "How do I get dynamic dispatch of methods?" and "Why is there no type inheritance?" in the language FAQ.
...
6. **^** ["Release 1.26.2"](https://github.com/golang/go/releases/tag/go1.26.2). April 7, 2026. Retrieved April 8, 2026.
...
14. **^** Kincaid, Jason (November 10, 2009). ["Google's Go: A New Programming Language That's Python Meets C++"](https://techcrunch.com/2009/11/10/google-go-language/). *[TechCrunch](https://en.wikipedia.org/wiki/TechCrunch)*. Retrieved January 18, 2010.
15. **^** Metz, Cade (May 5, 2011). ["Google Go boldly goes where no code has gone before"](https://www.theregister.com/2011/05/05/google_go/). *[The Register](https://en.wikipedia.org/wiki/The_Register)*. [Archived](https://web.archive.org/web/20250728222723/https://go.dev/doc/faq) from the original on July 28, 2025.
...
18. **^** ["The Go programming language"](https://github.com/golang/go). *[GitHub](https://en.wikipedia.org/wiki/GitHub)*. Retrieved November 1, 2024.
19. **^** ["gofrontend"](https://github.com/golang/gofrontend). *[GitHub](https://en.wikipedia.org/wiki/GitHub)*. Retrieved November 1, 2024.
...
22. **^** ["A compiler from Go to JavaScript for running Go code in a browser: Gopherjs/Gopherjs"](https://github.com/gopherjs/gopherjs). *[GitHub](https://en.wikipedia.org/wiki/GitHub)*. [Archived](https://web.archive.org/web/20231212143621/https://github.com/gopherjs/gopherjs) from the original on December 12, 2023.
...
24. **^** Pike, Rob (April 28, 2010). ["Another Go at Language Design"](http://www.stanford.edu/class/ee380/Abstracts/100428.html). *Stanford EE Computer Systems Colloquium*. [Stanford University](https://en.wikipedia.org/wiki/Stanford_University). [Video available](https://www.youtube.com/watch?v=7VcArS4Wpqk).
...
28. **^** Griesemer, Robert (2015). ["The Evolution of Go"](https://talks.golang.org/2015/gophercon-goevolution.slide#4).
...
33. **^** The Go Programming Language and Environment. Communications of the ACM. [https://dl.acm.org/doi/pdf/10.1145/3488716](https://dl.acm.org/doi/pdf/10.1145/3488716)
...
48. **^** ["Go 1.26 Release Notes"](https://go.dev/doc/go1.26). *The Go Programming Language*.
...
78. **^** Diggins, Christopher (November 24, 2009). ["Duck Typing and the Go Programming Language"](http://www.drdobbs.com/architecture-and-design/duck-typing-and-the-go-programming-langu/228701527). *Dr. Dobb's, The world of software development*. Retrieved March 10, 2016.
...
88. **^** ["Type Parameters Proposal"](https://go.googlesource.com/proposal/+/HEAD/design/43651-type-parameters.md). *go.googlesource.com*. Retrieved June 25, 2023.
...
91. **^** ["Type Parameters Proposal"](https://go.googlesource.com/proposal/+/HEAD/design/43651-type-parameters.md#using-a-constraint). *go.googlesource.com*. Retrieved June 25, 2023.
...
98. ^   Donovan, Alan A. A.; Kernighan, Brian W. (2016). *The Go programming language*. Addison-Wesley professional computing series. New York, Munich: Addison-Wesley. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-0-13-419044-0](https://en.wikipedia.org/wiki/Special:BookSources/978-0-13-419044-0).
99. ^      Chisnall, David (2012). [*The Go Programming Language Phrasebook*](https://books.google.com/books?id=scyH562VXZUC). Addison-Wesley. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [9780132919005](https://en.wikipedia.org/wiki/Special:BookSources/9780132919005).
...
110. **^** Nanz, Sebastian; West, Scott; Soares Da Silveira, Kaue. [*Examining the expert gap in parallel programming*](http://se.inf.ethz.ch/people/west/expert-gap-europar-2013.pdf) (PDF). Euro-Par 2013. [CiteSeerX](https://en.wikipedia.org/wiki/CiteSeerX_(identifier)) [10.1.1.368.6137](https://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.368.6137).
111. **^** Go Authors. ["Share Memory By Communicating"](https://go.dev/doc/codewalk/sharemem/).
112. **^** [Cox, Russ](https://en.wikipedia.org/wiki/Russ_Cox). ["Off to the Races"](http://research.swtch.com/gorace).
113. **^** [Pike, Rob](https://en.wikipedia.org/wiki/Rob_Pike) (October 25, 2012). ["Go at Google: Language Design in the Service of Software Engineering"](https://talks.golang.org/2012/splash.article). Google, Inc. "There is one important caveat: Go is not purely memory safe in the presence of concurrency."
...
121. **^** ["Language Design FAQ"](https://web.archive.org/web/20091113154906/http://golang.org/doc/go_lang_faq.html#absent_features). November 13, 2009. Archived from [the original](https://golang.org/doc/go_lang_faq.html#absent_features) on November 13, 2009.
...
131. **^** ["Code Review Comments"](https://github.com/golang/go/wiki/CodeReviewComments). *[GitHub](https://en.wikipedia.org/wiki/GitHub)*. Retrieved July 3, 2018.
...
151. **^** Metz, Cade (July 1, 2011). ["Google Go strikes back with C++ bake-off"](https://www.theregister.co.uk/2011/07/01/go_v_cpluplus_redux/). *[The Register](https://en.wikipedia.org/wiki/The_Register)*.
...
155. **^** ["proposal: os: Create/Open/OpenFile() set FILE_SHARE_DELETE on windows #32088"](https://github.com/golang/go/issues/32088). *[GitHub](https://en.wikipedia.org/wiki/GitHub)*. May 16, 2019. Retrieved November 17, 2020.
...
159. ^   ["Issue 9 - go — I have already used the name for *MY* programming language"](https://github.com/golang/go/issues/9#issuecomment-66047478). *Github*. [Google Inc.](https://en.wikipedia.org/wiki/Google_Inc.) Retrieved October 12, 2010.
...
NewPP limit report
Parsed by mw‐web.eqiad.main‐56dfd6f675‐b9kzs
Cached time: 20260424003504
Cache expiry: 86400
...
Real time usage: 3.610 seconds
Preprocessor visited node count: 15776/1000000
Revision size: 83198/2097152 bytes
Post‐expand include size: 323087/2097152 bytes
Template argument size: 16697/2097152 bytes
Highest expansion depth: 21/100
Expensive parser function count: 102/500
Unstrip recursion depth: 1/20
Unstrip post‐expand size: 622018/5000000 bytes
Lua time usage: 1.121/10.000 seconds
Lua memory usage: 13465797/52428800 bytes
Number of Wikibase entities loaded: 1/500

Transclusion expansion time report (%,ms,calls,template)
100.00% 3271.131      1 -total
 31.49% 1030.112     63 Template:Code
 22.74%  743.851      2 Template:Reflist
 15.09%  493.738    132 Template:Cite_web
 11.25%  368.042      2 Template:Infobox
 10.05%  328.866      1 Template:Infobox_programming_language
  6.04%  197.413      1 Template:Infobox_software/simple
  4.88%  159.620      2 Template:Wikidata
  3.89%  127.280      5 Template:Navbox
  3.43%  112.111      1 Template:Programming_languages
 Render ID 6f867393-3f75-11f1-9ebb-993ce85d5cad  Saved in parser cache with key enwiki:pcache:25039021:|#|:idhash:canonical and timestamp 20260424003504 and revision id 1348427000. Rendering was triggered because: page_view