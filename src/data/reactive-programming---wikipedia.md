...
Another example is a [hardware description language](https://en.wikipedia.org/wiki/Hardware_description_language) such as [Verilog](https://en.wikipedia.org/wiki/Verilog), where reactive programming enables changes to be modeled as they propagate through circuits.[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*]

Reactive programming has been proposed as a way to simplify the creation of interactive user interfaces and near-real-time system animation.[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=1)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=2)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=3)]

### Essence of implementations

[[edit](/w/index.php?title=Reactive_programming&action=edit&section=4)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=5)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=7)]
...
[![](//upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Reactive_programming_glitches.svg/250px-Reactive_programming_glitches.svg.png)](https://en.wikipedia.org/wiki/File:Reactive_programming_glitches.svg)
...
Some reactive languages are glitch-free and prove this property[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*]. This is usually achieved by [topologically sorting](https://en.wikipedia.org/wiki/Topological_sorting) expressions and updating values in topological order. This can, however, have performance implications, such as delaying the delivery of values (due to the order of propagation). In some cases, therefore, reactive languages permit glitches, and developers must be aware of the possibility that values may temporarily fail to correspond to the program source, and that some expressions may evaluate multiple times (for instance, `t > seconds` may evaluate twice: once when the new value of `seconds` arrives, and once more when `t` updates).

#### Cyclic dependencies

[[edit](/w/index.php?title=Reactive_programming&action=edit&section=9)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=10)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=11)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=13)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=15)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=16)]
...
[[edit](/w/index.php?title=Reactive_programming&action=edit&section=17)]
...
One inherent problem for reactive programming is that most computations that would be evaluated and forgotten in a normal programming language, needs to be represented in the memory as data-structures.[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*] This could potentially make reactive programming highly memory consuming. However, research on what is called *lowering* could potentially overcome this problem.

On the other side, reactive programming is a form of what could be described as "explicit parallelism"[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*], and could therefore be beneficial for utilizing the power of parallel hardware.

#### Similarities with observer pattern

[[edit](/w/index.php?title=Reactive_programming&action=edit&section=18)]
...
Object-oriented reactive programming (OORP) is a combination of object-oriented programming and reactive programming. Perhaps the most natural way to make such a combination is as follows: instead of methods and fields, objects have *reactions* that automatically re-evaluate when the other reactions they depend on have been modified.[*[citation needed](https://en.wikipedia.org/wiki/Wikipedia:Citation_needed)*]
