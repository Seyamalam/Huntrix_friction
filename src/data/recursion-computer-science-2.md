...
Tree fractal created using the 

[Logo programming language](https://en.wikipedia.org/wiki/Logo_(programming_language))

 and relying heavily on recursion. Each branch can be seen as a smaller version of a tree.Recursive drawing of a 
...
— Felleisen, Findler, Flatt, and Krishnaurthi, *[How to Design Programs](https://en.wikipedia.org/wiki/How_to_Design_Programs)*, 2001
...
A basic example of short-circuiting is given in [depth-first search](https://en.wikipedia.org/wiki/Depth-first_search) (DFS) of a binary tree; see binary trees section for standard recursive discussion.
...
In the case of a [perfect binary tree](https://en.wikipedia.org/wiki/Perfect_binary_tree) of height *h,* there are 2−1 nodes and 2 Null pointers as children (2 for each of the 2 leaves), so short-circuiting cuts the number of function calls in half in the worst case.
...
| [Tail recursion](https://en.wikipedia.org/wiki/Tail_recursion): | Augmenting recursion: |
| --- | --- |
...
{\displaystyle x\%y}
 ...
 expresses the [remainder](https://en.wikipedia.org/wiki/Remainder) of 
...
| --- |
| h1 = 1   = 2 - 1 h2 = 3   = 2 - 1 h3 = 7   = 2 - 1 h4 = 15  = 2 - 1 h5 = 31  = 2 - 1 h6 = 63  = 2 - 1 h7 = 127 = 2 - 1  In general: hn = 2 - 1, for all n >= 1 |
...
* [Recursion](https://en.wikipedia.org/wiki/Recursion) (in general)
...
* [Open recursion](https://en.wikipedia.org/wiki/Open_recursion)
...
* [μ-recursive functions](https://en.wikipedia.org/wiki/%CE%9C-recursive_function)
...
1. **^** Graham, Ronald; Knuth, Donald; Patashnik, Oren (1990). ["1: Recurrent Problems"](http://www-cs-faculty.stanford.edu/~knuth/gkp.html). *Concrete Mathematics*. Addison-Wesley. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [0-201-55802-5](https://en.wikipedia.org/wiki/Special:BookSources/0-201-55802-5).
...
3. **^** Epp, Susanna (1995). [*Discrete Mathematics with Applications*](https://archive.org/details/discretemathema000epps/page/427) (2nd ed.). PWS Publishing Company. p. [427](https://archive.org/details/discretemathema000epps/page/427). [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-0-53494446-9](https://en.wikipedia.org/wiki/Special:BookSources/978-0-53494446-9).
4. **^** [Wirth, Niklaus](https://en.wikipedia.org/wiki/Niklaus_Wirth) (1976). [*Algorithms + Data Structures = Programs*](https://archive.org/details/algorithmsdatast00wirt/page/126). [Prentice-Hall](https://en.wikipedia.org/wiki/Prentice-Hall). p. [126](https://archive.org/details/algorithmsdatast00wirt/page/126). [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-0-13022418-7](https://en.wikipedia.org/wiki/Special:BookSources/978-0-13022418-7).
5. **^** ["Functional Programming | Clojure for the Brave and True"](https://www.braveclojure.com/functional-programming/#Recursion_Instead_of_for_while). *www.braveclojure.com*. Retrieved 2020-10-21.
6. ^    Soare, Robert I. (1996). "Computability and Recursion". *Bulletin of Symbolic Logic*. **2** (3): 284–321. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.2307/420992](https://doi.org/10.2307%2F420992). [JSTOR](https://en.wikipedia.org/wiki/JSTOR_(identifier)) [420992](https://www.jstor.org/stable/420992).
7. ^       Daylight, Edgar G. (2010). The Advent of Recursion in Programming, 1950s–1960s (Report). Preprint Series PP-2010-04. University of Amsterdam, Institute for Logic, Language and Computation.
8. ^    McCarthy, John (1960). "Recursive Functions of Symbolic Expressions and Their Computation by Machine, Part I". *Communications of the ACM*. **3** (4): 184–195. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.1145/367177.367199](https://doi.org/10.1145%2F367177.367199).
9. ^   Naur, Peter; John Backus; John McCarthy (1960). "Report on the Algorithmic Language ALGOL 60". *Communications of the ACM*. **3** (5): 299–314. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.1145/367236.367262](https://doi.org/10.1145%2F367236.367262).
10. **^** Kong, Qingkai; Siauw, Timmy; Bayen, Alexandre M. (2021). "Recursion". *Python Programming and Numerical Methods*. pp. 105–120. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.1016/B978-0-12-819549-9.00015-4](https://doi.org/10.1016%2FB978-0-12-819549-9.00015-4). [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-0-12-819549-9](https://en.wikipedia.org/wiki/Special:BookSources/978-0-12-819549-9).
11. ^    Sweigart, Al (2022). *The Recursive Book of Recursion: Ace the Coding Interview with Python and JavaScript*. No Starch Press. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-1-7185-0202-4](https://en.wikipedia.org/wiki/Special:BookSources/978-1-7185-0202-4).
12. **^** Hopcroft, John; Tarjan, Robert (June 1973). "Algorithm 447: efficient algorithms for graph manipulation". *Communications of the ACM*. **16** (6): 372–378. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.1145/362248.362272](https://doi.org/10.1145%2F362248.362272).
13. **^** Bron, C. (May 1972). "Algorithm 426: Merge sort algorithm [M1]". *Communications of the ACM*. **15** (5): 357–358. [doi](https://en.wikipedia.org/wiki/Doi_(identifier)):[10.1145/355602.361317](https://doi.org/10.1145%2F355602.361317).
14. **^** Felleisen et al. 2001, [art V "Generative Recursion](http://www.htdp.org/2003-09-26/Book/curriculum-Z-H-31.html)
15. ^   Felleisen, Matthias (2002). ["Developing Interactive Web Programs"](https://books.google.com/books?id=Y3GqCAAAQBAJ&pg=PA108). In Jeuring, Johan (ed.). [*Advanced Functional Programming: 4th International School*](ftp://nozdr.ru/biblio/kolxo3/Cs/CsLn/Advanced%20Functional%20Programming%204%20conf.,%20AFP%202002%20(LNCS2638,%20Springer,%202003)(ISBN%203540401326)(O)(222s).pdf#page=109) (PDF). Springer. p. 108. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [9783540448334](https://en.wikipedia.org/wiki/Special:BookSources/9783540448334).
16. **^** Mongan, John; Giguère, Eric; Kindler, Noah (2013). [*Programming Interviews Exposed: Secrets to Landing Your Next Job*](https://archive.org/details/programminginter00mong_658) (3rd ed.). [Wiley](https://en.wikipedia.org/wiki/Wiley_(publisher)). p. [115](https://archive.org/details/programminginter00mong_658/page/n148). [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-1-118-26136-1](https://en.wikipedia.org/wiki/Special:BookSources/978-1-118-26136-1).
17. **^** Hetland, Magnus Lie (2010), [*Python Algorithms: Mastering Basic Algorithms in the Python Language*](https://books.google.com/books?id=4cytGpIPYsAC&pg=PA79), Apress, p. 79, [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [9781430232384](https://en.wikipedia.org/wiki/Special:BookSources/9781430232384).
18. **^** Drozdek, Adam (2012), [*Data Structures and Algorithms in C++*](https://books.google.com/books?id=PRgLAAAAQBAJ&pg=PA197) (4th ed.), Cengage Learning, p. 197, [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [9781285415017](https://en.wikipedia.org/wiki/Special:BookSources/9781285415017).
19. **^** Shivers, Olin. ["The Anatomy of a Loop - A story of scope and control"](http://www.ccs.neu.edu/home/shivers/papers/loop.pdf) (PDF). Georgia Institute of Technology. Retrieved 2012-09-03.
20. **^** Lambda the Ultimate. ["The Anatomy of a Loop"](http://lambda-the-ultimate.org/node/1014). Lambda the Ultimate. Retrieved 2012-09-03.
21. **^** ["27.1. sys — System-specific parameters and functions — Python v2.7.3 documentation"](https://docs.python.org/library/sys.html). Docs.python.org. Retrieved 2012-09-03.
22. **^** Krauss, Kirk J. (2014). ["Matching Wildcards: An Empirical Way to Tame an Algorithm"](http://www.drdobbs.com/architecture-and-design/matching-wildcards-an-empirical-way-to-t/240169123). *[Dr. Dobb's Journal](https://en.wikipedia.org/wiki/Dr._Dobb%27s_Journal)*.
23. **^** Mueller, Oliver (2012). ["Anatomy of a Stack Smashing Attack and How GCC Prevents It"](http://www.drdobbs.com/security/anatomy-of-a-stack-smashing-attack-and-h/240001832). *[Dr. Dobb's Journal](https://en.wikipedia.org/wiki/Dr._Dobb%27s_Journal)*.
24. **^** ["StackOverflowException Class"](https://msdn.microsoft.com/en-us/library/system.stackoverflowexception(v=vs.110).aspx). *.NET Framework Class Library*. [Microsoft Developer Network](https://en.wikipedia.org/wiki/Microsoft_Developer_Network). 2018.
25. **^** ["Depth First Search (DFS): Iterative and Recursive Implementation"](http://www.techiedelight.com/depth-first-search/). Techie Delight. 2018.
26. **^** Mitrovic, Ivan. ["Replace Recursion with Iteration"](https://www.refactoring.com/catalog/replaceRecursionWithIteration.html). [ThoughtWorks](https://en.wikipedia.org/wiki/ThoughtWorks).
27. **^** La, Woong Gyu (2015). ["How to replace recursive functions using stack and while-loop to avoid the stack-overflow"](https://www.codeproject.com/Articles/418776/How-to-replace-recursive-functions-using-stack-and). CodeProject.
28. **^** Moertel, Tom (2013). ["Tricks of the trade: Recursion to Iteration, Part 2: Eliminating Recursion with the Time-Traveling Secret Feature Trick"](http://blog.moertel.com/posts/2013-05-14-recursive-to-iterative-2.html).
29. **^** Salz, Rich (1991). ["wildmat.c"](https://github.com/trevor/transmission/blob/master/libtransmission/wildmat.c). [GitHub](https://en.wikipedia.org/wiki/GitHub).
30. **^** Krauss, Kirk J. (2008). ["Matching Wildcards: An Algorithm"](http://www.drdobbs.com/architecture-and-design/matching-wildcards-an-algorithm/210200888). *[Dr. Dobb's Journal](https://en.wikipedia.org/wiki/Dr._Dobb%27s_Journal)*.
31. **^** Krauss, Kirk J. (2018). ["Matching Wildcards: An Improved Algorithm for Big Data"](http://www.developforperformance.com/MatchingWildcards_AnImprovedAlgorithmForBigData.html). Develop for Performance.
32. **^** Graham, Knuth & Patashnik 1990, §1.1: The Tower of Hanoi
33. **^** Epp 1995, pp. 427–430: The Tower of Hanoi
34. **^** Epp 1995, pp. 447–448: An Explicit Formula for the Tower of Hanoi Sequence
35. **^** Wirth 1976, p. 127
36. **^** [Russell, Stuart J.](https://en.wikipedia.org/wiki/Stuart_J._Russell); [Norvig, Peter.](https://en.wikipedia.org/wiki/Peter_Norvig) (2021). *[Artificial Intelligence: A Modern Approach §9.3, §9.4](https://en.wikipedia.org/wiki/Artificial_Intelligence:_A_Modern_Approach)* (4th ed.). Hoboken: Pearson. [ISBN](https://en.wikipedia.org/wiki/ISBN_(identifier)) [978-0134610993](https://en.wikipedia.org/wiki/Special:BookSources/978-0134610993). [LCCN](https://en.wikipedia.org/wiki/LCCN_(identifier)) [20190474](https://lccn.loc.gov/20190474).
37. **^** ["4.8. Infinite Recursion — How to Think Like a Computer Scientist - C++"](https://runestone.academy/ns/books/published/thinkcpp/Chapter4/InfiniteRecursion.html).

## References

 
NewPP limit report
Parsed by mw‐web.codfw.main‐6d4c897766‐6wf6j
Cached time: 20260417044327
...
Revision size: 70237/2097152 bytes
Post‐expand include size: 151428/2097152 bytes
Template argument size: 4669/2097152 bytes
Highest expansion depth: 20/100
Expensive parser function count: 43/500
Unstrip recursion depth: 1/20
Unstrip post‐expand size: 225155/5000000 bytes
Lua time usage: 0.431/10.000 seconds
Lua memory usage: 9264416/52428800 bytes
Number of Wikibase entities loaded: 0/500

Transclusion expansion time report (%,ms,calls,template)
100.00%  675.103      1 -total
 38.96%  263.011      1 Template:Reflist
 20.51%  138.451     17 Template:Cite_book
 11.48%   77.518      4 Template:Navbox
 10.26%   69.249      1 Template:Programming_paradigms_navbox
  9.48%   64.030      1 Template:Short_description
  6.97%   47.035     11 Template:Cite_journal
  6.74%   45.508      2 Template:Pagetype
  6.00%   40.476      5 Template:Harvnb
  5.04%   34.032     12 Template:Cite_web
 Render ID f9838e53-3a17-11f1-b6cf-83ce80251f25  Saved in parser cache with key enwiki:pcache:4044867:|#|:idhash:canonical and timestamp 20260417044327 and revision id 1343397557. Rendering was triggered because: page_view