...
const modeCopy: Record<FrictionMode, { body: string; progress: number }> = {
	light: {
...
function CreatePostPage() {
	...
	const [title, setTitle] = useState("The cost of fake understanding");
					...
					<FieldGroup className="mt-8">
						<Field>
							...
							<Input
								...
								className="h-12 border-[#17140f]/15 bg-[#f9f6ef] text-base font-semibold"
							/>
						</Field>
						<Field>
							...
							<Textarea
								...
								className="min-h-[28rem] border-[#17140f]/15 bg-[#f9f6ef] text-sm leading-7"
							/>
